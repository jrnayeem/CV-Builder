...
const BDProfessionalLayout: React.FC<TemplateProps & { accentColor: string }> = ({ data, theme, accentColor }) => {
  ...
  return (
    <div className="w-[210mm] h-[297mm] flex flex-col bg-white text-left font-sans text-gray-900 border-4 border-white">
      <div className="flex justify-between items-start px-12 pt-12 pb-6 border-b-2" style={{ borderColor: accent }}>
      ...
      <div className="px-12 py-6 flex-1 flex flex-col gap-5">
        {data.objective && (
          <div className="w-full">
            <h2 className="text-sm font-bold uppercase py-1 mb-2 border-b" style={{ backgroundColor: accent + '20', color: accent, borderBottomColor: accent }}>Career Objective</h2>
            <p className="text-xs text-justify leading-relaxed">{data.objective}</p>
          </div>
        )}
        {data.education.length > 0 && (
          <div className="w-full">
            <h2 className="text-sm font-bold uppercase py-1 mb-2 border-b" style={{ backgroundColor: accent + '20', color: accent, borderBottomColor: accent }}>Educational Qualification</h2>
        ...
        {data.experience.length > 0 && (
          <div className="w-full">
            <h2 className="text-sm font-bold uppercase py-1 mb-2 border-b" style={{ backgroundColor: accent + '20', color: accent, borderBottomColor: accent }}>Experience</h2>
        ...
        <CustomSectionsBlock data={data} headingColor={accent} borderColor={accent} compact headingSize="text-sm font-bold uppercase" />
        <div className="w-full">
          <h2 className="text-sm font-bold uppercase py-1 mb-2 border-b" style={{ backgroundColor: accent + '20', color: accent, borderBottomColor: accent }}>Personal Details</h2>
        ...
        {data.references.length > 0 && (
          <div className="w-full">
            <h2 className="text-sm font-bold uppercase py-1 mb-2 border-b" style={{ backgroundColor: accent + '20', color: accent, borderBottomColor: accent }}>References</h2>
        ...
        <div className="w-full mt-auto pt-6 border-t border-gray-200">
          <SignatureBlock data={data} textColor="#111827" borderColor="#111827" compact />
        </div>
      </div>
    </div>
  );
