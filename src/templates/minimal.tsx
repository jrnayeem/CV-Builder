...
const MinimalLayout: React.FC<TemplateProps & { accentColor?: string; font?: string; isCentered?: boolean }> = ({ data, accentColor = "#000", font = "sans-serif", isCentered = false }) => (
  <div className="w-[210mm] h-[297mm] flex flex-col bg-white text-left text-black px-16 py-16" style={{ fontFamily: font }}>
    ...
    <div className="flex-1 grid grid-cols-12 gap-12">
      ...
      <div className="col-span-8 flex flex-col gap-10">
        ...
        <CustomSectionsBlock data={data} headingColor={accentColor} borderColor={accentColor} compact headingSize="text-xs font-bold uppercase tracking-widest" />
